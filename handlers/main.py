...
Username: @AHIMETYAHKA
Создатели: @AHIMETYAHKA
Новостной канал: нету
Игровой чат: назуй он нужен

<b>Что умеет Лоликон Бот | Чат-Бот:</b>
...
Если Вы были забанены по ошибке, напишите разработчику: @AHIMETYAHKA""", parse_mode="HTML")
                        except:
                            pass
                except:
